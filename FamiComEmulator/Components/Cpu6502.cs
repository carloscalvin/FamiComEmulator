...
namespace FamiComEmulator.Components
{
    public class Cpu6502 : ICpu6502
    {
        ...
        public Cpu6502()
        {
            ...
            _instructions[0, 3] = new Instruction { Name = "SLO", OperationCode = SLO, AddressingMode = IZX, Cycles = 8 };
            _instructions[0, 4] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 3 };
            ...
            _instructions[0, 7] = new Instruction { Name = "SLO", OperationCode = SLO, AddressingMode = ZP0, Cycles = 5 };
            ...
            _instructions[0, 12] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 4 };
            ...
            _instructions[0, 15] = new Instruction { Name = "SLO", OperationCode = SLO, AddressingMode = ABS, Cycles = 6 };
            ...
            _instructions[1, 3] = new Instruction { Name = "SLO", OperationCode = SLO, AddressingMode = IZY, Cycles = 8 };
            _instructions[1, 4] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 4 };
            ...
            _instructions[1, 7] = new Instruction { Name = "SLO", OperationCode = SLO, AddressingMode = ZPX, Cycles = 6 };
            ...
            _instructions[1, 10] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 2 };
            _instructions[1, 11] = new Instruction { Name = "SLO", OperationCode = SLO, AddressingMode = ABY, Cycles = 7 };
            _instructions[1, 12] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 4 };
            ...
            _instructions[1, 15] = new Instruction { Name = "SLO", OperationCode = SLO, AddressingMode = ABX, Cycles = 7 };
            ...
            _instructions[2, 3] = new Instruction { Name = "RLA", OperationCode = RLA, AddressingMode = IZX, Cycles = 8 };
            ...
            _instructions[2, 7] = new Instruction { Name = "RLA", OperationCode = RLA, AddressingMode = ZP0, Cycles = 5 };
            ...
            _instructions[2, 15] = new Instruction { Name = "RLA", OperationCode = RLA, AddressingMode = ABS, Cycles = 6 };
            ...
            _instructions[3, 3] = new Instruction { Name = "RLA", OperationCode = RLA, AddressingMode = IZY, Cycles = 8 };
            _instructions[3, 4] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 4 };
            ...
            _instructions[3, 7] = new Instruction { Name = "RLA", OperationCode = RLA, AddressingMode = ZPX, Cycles = 6 };
            ...
            _instructions[3, 10] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 2 };
            _instructions[3, 11] = new Instruction { Name = "RLA", OperationCode = RLA, AddressingMode = ABY, Cycles = 7 };
            _instructions[3, 12] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 4 };
            ...
            _instructions[3, 15] = new Instruction { Name = "RLA", OperationCode = RLA, AddressingMode = ABX, Cycles = 7 };
            ...
            _instructions[4, 3] = new Instruction { Name = "SRE", OperationCode = SRE, AddressingMode = IZX, Cycles = 8 };
            _instructions[4, 4] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 3 };
            ...
            _instructions[4, 7] = new Instruction { Name = "SRE", OperationCode = SRE, AddressingMode = ZP0, Cycles = 5 };
            ...
            _instructions[4, 15] = new Instruction { Name = "SRE", OperationCode = SRE, AddressingMode = ABS, Cycles = 6 };
            ...
            _instructions[5, 3] = new Instruction { Name = "SRE", OperationCode = SRE, AddressingMode = IZY, Cycles = 8 };
            _instructions[5, 4] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 4 };
            ...
            _instructions[5, 7] = new Instruction { Name = "SRE", OperationCode = SRE, AddressingMode = ZPX, Cycles = 6 };
            ...
            _instructions[5, 10] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 2 };
            _instructions[5, 11] = new Instruction { Name = "SRE", OperationCode = SRE, AddressingMode = ABY, Cycles = 7 };
            _instructions[5, 12] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 4 };
            ...
            _instructions[5, 15] = new Instruction { Name = "SRE", OperationCode = SRE, AddressingMode = ABX, Cycles = 7 };
            ...
            _instructions[6, 3] = new Instruction { Name = "RRA", OperationCode = RRA, AddressingMode = IZX, Cycles = 8 };
            _instructions[6, 4] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 3 };
            ...
            _instructions[6, 15] = new Instruction { Name = "RRA", OperationCode = RRA, AddressingMode = ABS, Cycles = 6 };
            ...
            _instructions[7, 4] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 4 };
            ...
            _instructions[7, 7] = new Instruction { Name = "RRA", OperationCode = RRA, AddressingMode = ZPX, Cycles = 6 };
            ...
            _instructions[7, 10] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 2 };
            _instructions[7, 11] = new Instruction { Name = "RRA", OperationCode = RRA, AddressingMode = ABY, Cycles = 6 };
            _instructions[7, 12] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 4 };
            ...
            _instructions[8, 0] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 2 };
            _instructions[8, 1] = new Instruction { Name = "STA", OperationCode = STA, AddressingMode = IZX, Cycles = 6 };
            _instructions[8, 2] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 2 };
            _instructions[8, 3] = new Instruction { Name = "SAX", OperationCode = SAX, AddressingMode = IZX, Cycles = 6 };
            ...
            _instructions[8, 7] = new Instruction { Name = "SAX", OperationCode = SAX, AddressingMode = ZP0, Cycles = 3 };
            _instructions[8, 8] = new Instruction { Name = "DEY", OperationCode = DEY, AddressingMode = IMP, Cycles = 2 };
            _instructions[8, 9] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 2 };
            ...
            _instructions[8, 15] = new Instruction { Name = "SAX", OperationCode = SAX, AddressingMode = ABS, Cycles = 4 };
            ...
            _instructions[9, 3] = new Instruction { Name = "SAX", OperationCode = SAX, AddressingMode = ZPY, Cycles = 4 };
            ...
            _instructions[9, 7] = new Instruction { Name = "SAX", OperationCode = SAX, AddressingMode = ZPY, Cycles = 4 };
            ...
            _instructions[9, 12] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 5 };
            ...
            _instructions[10, 3] = new Instruction { Name = "LAX", OperationCode = LAX, AddressingMode = IZX, Cycles = 6 };
            ...
            _instructions[10, 7] = new Instruction { Name = "LAX", OperationCode = LAX, AddressingMode = ZP0, Cycles = 3 };
            ...
            _instructions[10, 15] = new Instruction { Name = "LAX", OperationCode = LAX, AddressingMode = ABS, Cycles = 4 };
            ...
            _instructions[11, 3] = new Instruction { Name = "LAX", OperationCode = LAX, AddressingMode = IZY, Cycles = 5 };
            ...
            _instructions[11, 7] = new Instruction { Name = "LAX", OperationCode = LAX, AddressingMode = ZPY, Cycles = 4 };
            ...
            _instructions[11, 15] = new Instruction { Name = "LAX", OperationCode = LAX, AddressingMode = ABY, Cycles = 4 };
            ...
            _instructions[12, 2] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 2 };
            _instructions[12, 3] = new Instruction { Name = "DCP", OperationCode = DCP, AddressingMode = IZX, Cycles = 8 };
            ...
            _instructions[12, 7] = new Instruction { Name = "DCP", OperationCode = DCP, AddressingMode = ZP0, Cycles = 5 };
            ...
            _instructions[12, 15] = new Instruction { Name = "DCP", OperationCode = DCP, AddressingMode = ABS, Cycles = 6 };
            ...
            _instructions[13, 3] = new Instruction { Name = "DCP", OperationCode = DCP, AddressingMode = IZY, Cycles = 8 };
            _instructions[13, 4] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 4 };
            ...
            _instructions[13, 7] = new Instruction { Name = "DCP", OperationCode = DCP, AddressingMode = ZPX, Cycles = 6 };
            ...
            _instructions[13, 11] = new Instruction { Name = "DCP", OperationCode = DCP, AddressingMode = ABY, Cycles = 7 };
            _instructions[13, 12] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 4 };
            ...
            _instructions[13, 15] = new Instruction { Name = "DCP", OperationCode = DCP, AddressingMode = ABX, Cycles = 7 };
            ...
            _instructions[14, 2] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 2 };
            _instructions[14, 3] = new Instruction { Name = "ISB", OperationCode = ISB, AddressingMode = IZX, Cycles = 8 };
            ...
            _instructions[14, 7] = new Instruction { Name = "ISB", OperationCode = ISB, AddressingMode = ZP0, Cycles = 5 };
            ...
            _instructions[14, 11] = new Instruction { Name = "SBC", OperationCode = SBC, AddressingMode = IMM, Cycles = 2 };
            ...
            _instructions[14, 15] = new Instruction { Name = "ISB", OperationCode = ISB, AddressingMode = ABS, Cycles = 6 };
            ...
            _instructions[15, 4] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 4 };
            ...
            _instructions[15, 7] = new Instruction { Name = "ISB", OperationCode = ISB, AddressingMode = ZPX, Cycles = 6 };
            ...
            _instructions[15, 12] = new Instruction { Name = "NOP", OperationCode = NOP, AddressingMode = IMP, Cycles = 4 };
        ...
        public void Reset()
        {
            ...
            YRegister = 0;
            StackPointer = 0xFD;
            Status = Flags6502.Unused | Flags6502.DisableInterrupts;
        ...
        private void FetchZeroPageXAddress()
        {
            byte address = (byte)(Read(ProgramCounter) + XRegister); // Read Zero Page address with X offset
            ProgramCounter++;                                        // Increment the Program Counter
            Read(address);                                           // Perform the read, although we don't store the value
        }

        private void FetchZeroPageAddress()
        {
            ushort address = Read(ProgramCounter); // Read the Zero Page address
            ProgramCounter++;                      // Increment the Program Counter
            Read(address);                         // Perform the read, although we don't store the value
        }

        private void FetchAbsoluteAddress()
        {
            ushort lo = Read(ProgramCounter);     // Read low byte of the address
            ProgramCounter++;                     // Increment the Program Counter
            ushort hi = Read(ProgramCounter);     // Read high byte of the address
            ProgramCounter++;                     // Increment the Program Counter
            ushort address = (ushort)((hi << 8) | lo); // Combine to form the absolute address
            Read(address);                        // Perform the read, but don't use the result
        }
        ...
        private byte RRA()
        {
            ...
            ushort rotatedValue = (byte)(temp & 0x00FF);
            int sum = Accumulator + rotatedValue + (GetFlag(Flags6502.CarryBit));

            SetFlag(Flags6502.CarryBit, sum > 255);
            SetFlag(Flags6502.Zero, (sum & 0x00FF) == 0);
            SetFlag(Flags6502.Overflow, (~(Accumulator ^ rotatedValue) & (Accumulator ^ sum) & 0x0080) != 0);
        ...
        {
            Fetch();
            ushort tempValue = (ushort)(_fetchedData << 1);
            Write(_address_abs, (byte)(tempValue & 0x00FF));

            SetFlag(Flags6502.CarryBit, (tempValue & 0xFF00) != 0);
        ...
        {
            Fetch();
            byte value = (byte)(_fetchedData - 1);
            Write(_address_abs, value);
            ushort result = (ushort)(Accumulator - value);
            SetFlag(Flags6502.CarryBit, Accumulator >= value);
            SetFlag(Flags6502.Zero, (result & 0x00FF) == 0);
            SetFlag(Flags6502.Negative, (result & 0x0080) != 0);
        ...
        private byte NOP()
        {
            // Handle "illegal" NOP instructions that consume extra cycles
            switch (_opcode)
            {
                case 0x1C:
                case 0x3C:
                ...
                case 0xFC:
                    {
                        // Fetch the low byte of the absolute address
                        ushort addrLo = Read(ProgramCounter);
                        ProgramCounter++;
                        // Fetch the high byte of the absolute address
                        ushort addrHi = Read(ProgramCounter);
                        ProgramCounter++;

                        // Combine into a full 16-bit address and add the X register
                        ushort address = (ushort)((addrHi << 8) | addrLo);
                        ushort finalAddress = (ushort)(address + XRegister);

                        // If there's a page boundary cross, add a cycle
                        if ((address & 0xFF00) != (finalAddress & 0xFF00))
                        {
                            _cycles++;
                        }

                        // NOP doesn't actually do anything with this address; just a dummy read
                        Read(finalAddress);
                        return 1;  // Some NOPs take an additional cycle
                    }

                // NOP instructions that access Zero Page memory (illegal opcodes)
                case 0x04:
                case 0x44:
                case 0x64:
                    FetchZeroPageAddress(); // Read from Zero Page address
                    break;

                // Absolute memory access NOPs (illegal opcodes)
                case 0x0C:
                    FetchAbsoluteAddress(); // Read from absolute memory address
                    break;

                // Zero Page,X memory access NOP (illegal opcode)
                case 0x14:
                case 0x34:
                case 0x54:
                case 0x74:
        ...
        private byte ISB()
        {
            Fetch();
            ushort tempValue = (ushort)(_fetchedData + 1);
            Write(_address_abs, (byte)tempValue);

            int value = tempValue ^ 0xFF;
            int sum = Accumulator + value + (GetFlag(Flags6502.CarryBit));
        ...
        private byte SAX()
        {
            byte result = (byte)(Accumulator & XRegister);
            Write(_address_abs, result);
            return 0;
        }
